...
struct DimensResource {
    ...
    struct News {
        ...
        static let compactPostImageHeight: CGFloat = if UIDevice.isIPad { 260 } else { 160 }
        static let postImageHeight: CGFloat = if UIDevice.isIPad { 300 } else { 200 }
    }
    
    struct Mission {
        static let missionImageHeight: CGFloat = if UIDevice.isIPad { 300 } else { 200 }
        static let missionCardImageHeight: CGFloat = if UIDevice.isIPad { 280 } else { 180 }
    }
}
